 ...
 * generated in the it.prova.gestioneassicurati.xml package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.prova.gestioneassicurati.xml
     * 
     */
